package dev.mias.core.agent

import dev.mias.core.common.MiasResult
import kotlinx.serialization.Serializable

/**
 * Contract for an agent capability that Mias can invoke as a tool.
...
interface AgentCapability {
    ...
    suspend fun execute(input: Map<String, String>): MiasResult<String>
}
