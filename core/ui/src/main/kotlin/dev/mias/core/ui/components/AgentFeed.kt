...
fun AgentFeedItem(
    ...
    Row(
        modifier = modifier
            ...
            .alpha(alpha)
            .background(
                color = if (result.success) MiasColors.SurfaceGlass else MiasColors.ErrorRed.copy(alpha = 0.08f),
        ...
        AnimatedContent(
            ...
            Icon(
                ...
                tint = if (success) MiasColors.NeonCyan else MiasColors.ErrorRed,
                modifier = Modifier.size(16.dp),
            )
        }
    }
...
private fun toolColor(tool: String): Color = when {
    ...
    tool.contains("search") -> MiasColors.NeonCyan
