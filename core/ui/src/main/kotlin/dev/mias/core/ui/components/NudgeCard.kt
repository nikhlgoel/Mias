...
private fun NudgeType.toIconAndColor(): Pair<ImageVector, Color> = when (this) {
    NudgeType.SUGGESTION -> Icons.Rounded.AutoAwesome to MiasColors.Primary
    NudgeType.REMINDER -> Icons.Rounded.Schedule to MiasColors.CognitionOffloading
    NudgeType.INSIGHT -> Icons.Rounded.TipsAndUpdates to MiasColors.CognitionActing
    NudgeType.GREETING -> Icons.Rounded.AutoAwesome to MiasColors.SentimentHappy
}
