module.exports = {
  ...
  transformIgnorePatterns: [
    'node_modules/(?!((jest-)?react-native|@react-native(-community)?|@react-navigation|react-native-screens|react-native-image-picker|react-native-get-random-values|@noble|@mias)/)',
  ],
